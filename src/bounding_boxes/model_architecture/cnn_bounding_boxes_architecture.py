...
class cnn_model_bounding_boxes(nn.Module):
    ...
    def __init__(self, input_size, anz_channels=3):
        ...
        kernel_size = 3
        out_channels = 8
        self.conv_layer1 = nn.Conv2d(in_channels=anz_channels, out_channels=out_channels, kernel_size=kernel_size,
        ...
        self.fc1 = nn.Linear(final_out_channels * new_img_dimensions * new_img_dimensions, 128)
        self.relu1 = nn.ReLU()
